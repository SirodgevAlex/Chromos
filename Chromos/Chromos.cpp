...
// Chromos.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CChromosApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CChromosApp

CChromosApp::CChromosApp()
{
...
// Единственный объект CChromosApp

CChromosApp theApp;


// Инициализация CChromosApp

BOOL CChromosApp::InitInstance()
{
